...
use git::commands::{
    ...
    git_delete_branch, git_fetch, git_fetch_with_credentials, git_forget_credentials, git_pull,
    git_pull_with_credentials, git_push, git_push_with_credentials, git_rename_branch,
    git_switch_branch, open_git_remote,
};
use menu::{
