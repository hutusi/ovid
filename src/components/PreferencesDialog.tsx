...
export function PreferencesDialog({
  ...
  return (
    <Modal ariaLabel={t("preferences.title")} onClose={onClose} panelClassName="pref-panel">
          ...
          {activeTab === "general" && (
            <div className="pref-field">
              <label htmlFor="pref-restore-session" className="pref-field-label">
                <span className="pref-field-name">{t("preferences.general.restore_session")}</span>
            ...
            <>
              ...
              <div className="pref-field">
                <label htmlFor="pref-goal" className="pref-field-label">
                  <span className="pref-field-name">{t("preferences.editor.word_count_goal")}</span>
                  <span className="pref-field-hint">
